...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    { title: `Edit ${props.section.name}` },
];

const form = useForm({
    name: props.section.name,
    strand_id: String(props.section.strand_id),
    semester_id: String(props.section.semester_id),
    grade_level: String(props.section.grade_level),
